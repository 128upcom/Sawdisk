...
1. Go to **Scan**.
2. Choose a drive (e.g. `/mnt/volumes/YourDrive` or `/mnt/users` for macOS system drive).
...
docker compose exec python python workspace/SawDisk/main.py -p /mnt/volumes/YourDrive -f html -o /app/data/reports
